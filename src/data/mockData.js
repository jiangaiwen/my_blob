...
export const categories = [
  { id: 1, name: '随笔', count: 5, color: '#6366f1' },
  { id: 2, name: '技术', count: 4, color: '#10b981' },
  { id: 3, name: '生活', count: 3, color: '#f59e0b' },
  { id: 4, name: '读书', count: 2, color: '#ec4899' },
  { id: 5, name: '旅行', count: 1, color: '#06b6d4' }
]
...
export const articles = [
  {
    id: 1,
    title: '秋日私语',
    excerpt: '秋风起，落叶黄，一叶知秋的时节，总能勾起人们心底最柔软的记忆。漫步在林间小道，脚下是沙沙作响的落叶，空气中弥漫着果实成熟的香气。',
    content: `# 秋日私语
...
秋天的美，美在一份清澈，美在一份宁静。愿你我都能在这个秋天，找到属于自己的那份从容与淡然。`,
  ...
  },
  {
    ...
    excerpt: '深入解析 Vue3 Composition API 的核心概念与实践技巧，从响应式系统到自定义 Hook，全面掌握新一代 Vue 开发范式。',
...
Composition API 提供了更灵活的代码组织方式，是 Vue3 开发的核心。`,
  ...
  },
  {
    id: 3,
    title: '深夜的咖啡馆',
    excerpt: '城市的喧嚣在深夜渐渐平息，而咖啡馆里的灯光却依然温暖。推开那扇熟悉的门，咖啡的香气扑面而来，仿佛回到了某个遥远的夜晚。',
    content: `# 深夜的咖啡馆
...
它不只是一个喝咖啡的地方，更是一个让灵魂暂时歇息的空间。在这里，你可以卸下所有的伪装，面对最真实的自己。`,
  ...
  },
  {
    ...
    excerpt: '从基础概念到高级应用，系统性地掌握 CSS Grid 布局技术，打造现代化响应式页面设计。',
...
Grid 布局让复杂的页面结构变得简单明了，是现代 CSS 布局的重要工具。`,
  ...
  },
  {
    id: 5,
    title: '雨后山林',
    excerpt: '一场秋雨过后，山林间弥漫着清新的气息。雾气缭绕，仿佛置身于仙境之中，让人忘却尘世的烦恼。',
    content: `# 雨后山林
...
在这里，一切都慢了下来。没有城市的喧嚣，只有鸟鸣和水声。`,
    cover: 'https://images.unsplash.com/photo-1476231682828-37e571bc172f?w=800&q=80',
    category: 3,
    tags: [6, 9],
    views: 567,
    likes: 45,
  ...
  {
    id: 6,
    title: 'Node.js 异步编程精髓',
    excerpt: '深入理解 Node.js 事件循环、Promise、async/await，掌握高效的异步编程模式。',
    content: `# Node.js 异步编程精髓
...
4. 合理使用 Promise.all`,
  ...
  },
  {
    id: 7,
    title: '月光下的思念',
    excerpt: '月光如水，洒落在窗前的那株桂花树上。桂香暗浮，月色清朗，今夜的月，格外惹人思念。',
    content: `# 月光下的思念
...
我知道，无论相隔多远，月光总会将我们的思念相连。`,
  ...
  },
  {
    id: 8,
    title: 'Python 数据处理实战',
    excerpt: '使用 Pandas、NumPy 进行数据清洗、分析与可视化，打造数据驱动的研究报告。',
    content: `# Python 数据处理实战
...
Python 提供了强大的数据处理能力，是数据科学家的首选工具。`,
    ...
    updateTime: '2024-09-22'
  },
  {
    id: 9,
    title: '江南水乡',
    excerpt: '小桥流水，粉墙黛瓦。江南的美，美在一份诗意的婉约，让人沉醉不知归路。',
    content: `# 江南水乡
...
青石板铺就的小巷，两旁是古色古香的店铺。在这里，时间仿佛慢了下来。`,
    cover: 'https://images.unsplash.com/photo-1537531383496-f4749b8032cf?w=800&q=80',
    category: 3,
    tags: [6, 9],
    views: 921,
    likes: 78,
  ...
  },
  {
    id: 10,
    title: '读书笔记：《百年孤独》',
    excerpt: '魔幻现实主义的巅峰之作，布恩迪亚家族七代人的传奇故事，折射出拉丁美洲一个世纪以来风云变幻的历史。',
    content: `# 读书笔记：《百年孤独》
...
这部小说以其独特的叙事方式和丰富的想象力，构建了一个既真实又魔幻的世界。布恩迪亚家族的故事，是人类文明的一个缩影。`,
    cover: 'https://images.unsplash.com/photo-1544716278-ca5e235f7b2d?w=800&q=80',
    category: 4,
    tags: [6],
    views: 634,
    likes: 52,
  ...
  },
  {
    id: 11,
    title: '北疆秋色',
    excerpt: '金秋十月，北疆的胡杨林换上了金色的盛装。蓝天白云下，金色的树叶与远处的雪山相映成趣，构成一幅壮美的画卷。',
    content: `# 北疆秋色
...
拍摄胡杨林的最佳时间是日出和日落，光线柔和，色彩饱满。`,
  ...
  },
  {
    id: 12,
    title: 'Web 设计趋势 2024',
    excerpt: '从极简主义到动态界面，探索今年最具影响力的网页设计趋势与创新方向。',
    content: `# Web 设计趋势 2024
...
export const messages = [
  {
    ...
    content: '博客设计得非常精美，内容也很优质，会持续关注的！',
    createTime: '2024-10-15 14:30'
  },
  {
    id: 2,
    nickname: '路过的诗人',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Luna',
    content: '文字很美，让人感到宁静。这片精神家园真的很棒。',
    createTime: '2024-10-14 19:22'
  },
  {
    id: 3,
    nickname: '技术爱好者',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Mike',
    content: 'Vue3 的文章写得深入浅出，学到了很多！',
    createTime: '2024-10-13 09:15'
  },
  {
    id: 4,
    nickname: '晨曦',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Daisy',
    content: '喜欢这种简约而不简单的风格，继续加油！',
    createTime: '2024-10-12 21:45'
  },
  {
    id: 5,
    nickname: '夜行者',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Shadow',
    content: '深夜来这里读一篇文章，感觉整个人都被治愈了。',
    createTime: '2024-10-11 23:58'
  }
]
...
// 友链数据
export const links = [
  { id: 1, name: '破冰', url: 'https://hao.love', description: '一个有温度的技术博客', avatar: 'https://api.dicebear.com/7.x/identicon/svg?seed=Ice' },
  { id: 2, name: '静谧之林', url: 'https:// forest.com', description: '记录生活的点滴美好', avatar: 'https://api.dicebear.com/7.x/identicon/svg?seed=Forest' },
  { id: 3, name: '技术小站', url: 'https://tech.site', description: '分享前端技术与经验', avatar: 'https://api.dicebear.com/7.x/identicon/svg?seed=Tech' },
  { id: 4, name: '诗与远方', url: 'https://poetry.com', description: '用文字丈量世界', avatar: 'https://api.dicebear.com/7.x/identicon/svg?seed=Poetry' },
  { id: 5, name: '摄影集', url: 'https://photo.com', description: '用镜头捕捉瞬间', avatar: 'https://api.dicebear.com/7.x/identicon/svg?seed=Photo' },
  { id: 6, name: '读书笔记', url: 'https://reading.com', description: '阅读，思考，成长', avatar: 'https://api.dicebear.com/7.x/identicon/svg?seed=Book' }
]
